<template>
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('sppd')" :active="$page.currentRouteName == 'sppd'">
                                SPPD
                            </jet-nav-link>
                            <jet-nav-link :href="route('employes')" :active="$page.currentRouteName == 'employes'">
                                Data Pegawai
                            </jet-nav-link>
                        </div>
                    </div>
        ...
        <header class="bg-gray-200 shadow">
            <div class="flex max-w-7xl mx-auto pl-6 pr-6 px-4 pt-2 pb-2 sm:px-6 lg:px-8">
